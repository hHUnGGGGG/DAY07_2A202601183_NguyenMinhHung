...
**Họ tên:** Hoàng Anh Quân — 2A202601875
**Nhóm:** B4-E402 — vai trò: **Benchmark owner** (phụ trách `bench_queries.py`)
**Ngày:** 3/8/2026
**Chiến lược chunking của tôi:** `SentenceChunker(max_sentences_per_chunk=3)`
